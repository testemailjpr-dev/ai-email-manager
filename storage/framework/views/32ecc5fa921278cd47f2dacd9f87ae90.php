        ...
        <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $emails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                            	<td><input type="checkbox" name="email_ids[]" value="<?php echo e($msg['id']); ?>" class="email-checkbox"></td>
                                <td><?php echo e($msg['from']); ?></td>
                                <td><a href="<?php echo e(route('emails.show', $msg['id'])); ?>"><?php echo e($msg['subject']); ?></a></td>
                                <td><?php echo e($msg['summary'] ?? '(processing...)'); ?></td>
                                <td><?php echo e($msg['category'] ?? 'Uncategorized'); ?></td>
                                <td><?php echo e($msg['date']); ?></td>
                                <?php if($showAccount): ?>
            ...
            <?php if($nextPageToken): ?>
                <div class="text-center mt-4">
                    <a href="<?php echo e(route('emails.index', ['pageToken' => $nextPageToken])); ?>" class="btn btn-primary">
                        Load Next Emails
                    </a>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\vstep\ai-email-manager\resources\views/emails/index.blade.php ENDPATH**/ ?>